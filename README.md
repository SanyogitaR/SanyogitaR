...
- 📊 **Data Science & Analytics Explorer** unlocking insights from datasets with **Power BI, SQL & Excel**.  
- 🎨 **UI/UX Designer** crafting sleek, user-focused digital experiences.  
- 📱 **React Native Developer** building cross-platform mobile apps.  
- 🌐 **Full-Stack Web Developer** turning ideas into responsive, interactive websites.  
